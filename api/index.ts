...
// Redirigir a NGSO: consultar las etiquetas actuales del contacto de People
...
// Redirigir a NGSO: el asesor solo deja la solicitud pendiente de aprobación
// (eso lo guarda el cliente directo en Firestore). Este endpoint es la
// ejecución real — mensaje al cliente, etiquetas y correo de aviso a NGSO —
// y solo lo dispara un aprobador desde NgsoValidation al aprobar.
